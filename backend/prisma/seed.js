...
async function main() {
  const categories = [
    ...
    },
    {
      ...
      description: 'Producción audiovisual y narrativa visual.',
    },
    {
      name: 'Modelado 3D',
      slug: 'modelado-3d',
    ...
    },
    {
      ...
      description: 'Automatización y experiencias inteligentes.',
    },
    {
  ...
  const projects = [
    ...
    },
    {
      ...
      shortDescription: 'Sistema colaborativo para revisión y gestión de modelos 3D.',
      longDescription: 'Herramienta web para control de versiones y flujos de aprobación en proyectos 3D.',
      status: 'published',
    ...
    },
    {
      ...
      slug: 'dissau-wallet',
      category: 'Desarrollo web',
      shortDescription: 'Módulo de billetera digital con transferencias e historial de movimientos.',
    ...
    },
    {
      ...
      shortDescription: 'CMS con flujo editorial y automatización de publicaciones.',
      longDescription: 'Sistema orientado a equipos de contenido con historial de revisiones y publicación programada.',
      status: 'draft',
    ...
    },
    {
      ...
      shortDescription: 'Exploración de ideas, mecánicas y prototipos para entretenimiento digital.',
      longDescription: 'Línea de investigación y desarrollo para experiencias jugables futuras.',
      status: 'coming_soon',
      coverImageUrl: '/images/1013143.png',
  ...
  const products = [
    {
      ...
      type: 'template',
      shortDescription: 'Base web corporativa lista para personalización empresarial.',
      longDescription: 'Plantilla adaptable para presencia digital profesional con páginas clave incluidas.',
    ...
    },
    {
      ...
      type: 'game',
      shortDescription: 'Servicio-producto para validar mecánicas y experiencia de juego.',
      longDescription: 'Incluye definición de loop jugable, arte base y pruebas tempranas.',
    ...
    },
    {
      ...
      type: '3d',
      shortDescription: 'Visualización 3D para presentaciones comerciales y ecommerce.',
