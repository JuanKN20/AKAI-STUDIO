...
VALUES
  ...
  ('Animacion 2D/3D', 'animacion-2d-3d', 'Produccion audiovisual y narrativa visual.'),
  ('Modelado 3D', 'modelado-3d', 'Assets y visualizaciones tridimensionales.'),
  ('Inteligencia artificial', 'inteligencia-artificial', 'Automatizacion y experiencias inteligentes.'),
...
VALUES
  ...
  (
    'Videojuegos',
    'videojuegos',
    'Disenamos y desarrollamos experiencias de juego desde concepto hasta prototipo funcional.',
    ARRAY['Diseno de mecanicas', 'Prototipos jugables y direccion visual'],
    'Gamepad2',
    TRUE,
    2
  ),
  ...
  (
    ...
    ARRAY['Assets y entornos 3D', 'Optimizacion para uso interactivo'],
    'Boxes',
    TRUE,
    4
  ),
  (
    ...
    'inteligencia-artificial',
    'Exploramos soluciones con IA para automatizacion de flujos y nuevos productos.',
    ARRAY['Prototipos con IA', 'Automatizacion de tareas'],
    'Bot',
    TRUE,
    5
  ),
  (
    ...
    'Construimos identidad visual y contenido multimedia con enfoque estrategico.',
    ARRAY['Sistema visual de marca', 'Contenido para comunicacion digital'],
    'Palette',
    TRUE,
    6
  )
...
VALUES
  (
    ...
    'Plataforma corporativa para comunicar oferta de valor del estudio creativo y tecnologico.',
    'published',
  ...
  (
    ...
    'kaleido-lab',
    'Modelado 3D',
    'Sistema colaborativo para revision y gestion de modelos 3D.',
    'Herramienta web para control de versiones y flujos de aprobacion en proyectos 3D.',
    'published',
    '/images/1013143.png',
    NULL,
    NULL,
  ...
  (
    ...
    'dissau-wallet',
    'Desarrollo web',
    'Modulo de billetera digital con transferencias e historial de movimientos.',
  ...
  (
    ...
    'emcali-cms',
    'Branding y contenido digital',
    'CMS con flujo editorial y automatizacion de publicaciones.',
    'Sistema orientado a equipos de contenido con historial de revisiones y publicacion programada.',
    'draft',
    '/images/LogoAkai.png',
    NULL,
    NULL,
  ...
  (
    ...
    'Videojuegos',
    'Exploracion de ideas, mecanicas y prototipos para entretenimiento digital.',
    'Linea de investigacion y desarrollo para experiencias jugables futuras.',
    'coming_soon',
    '/images/1013143.png',
    NULL,
    NULL,
...
VALUES
  (
    ...
    'plantilla-web-corporativa',
    'template',
    'Base web corporativa lista para personalizacion empresarial.',
    'Plantilla adaptable para presencia digital profesional con paginas clave incluidas.',
    'Desde USD 499',
    'published',
    '/images/Logo/Logo.png',
    ARRAY['/images/Logo/Logo.png'],
  ...
  (
    ...
    'game',
    'Servicio-producto para validar mecanicas y experiencia de juego.',
    'Incluye definicion de loop jugable, arte base y pruebas tempranas.',
    'Desde USD 1,200',
    'coming_soon',
    '/images/1013143.png',
