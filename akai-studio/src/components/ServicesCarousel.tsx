...
const ServicesCarousel: React.FC = () => {
  ...
  return (
    <section className="relative px-8 py-16 bg-gradient-to-b  to-blak">
      <h2 className="text-3xl font-bold text-red-700 mb-8">Servicios</h2>
      <div className="relative w-full h-[60vh] rounded-lg overflow-hidden shadow-lg">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center bg-black bg-opacity-50 text-white p-8 text-center">
          ...
          <button
            ...
            className="mt-6 px-6 py-2 bg-red-700 text-white font-semibold rounded-full text-sm hover:bg-red-950 transition transform hover:scale-105"
          >
            Ver más
          </button>
        </div>
      ...
      <div className="flex justify-center mt-8 space-x-4">
        {servicesH.map((serviceH, index) => (
          <button
            ...
            className={`w-4 h-4 rounded-full ${index === currentServiceIndex ? 'bg-red-600' : 'bg-gray-400'
