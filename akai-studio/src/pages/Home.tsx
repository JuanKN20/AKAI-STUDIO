...
const Home: React.FC = () => {
  return (
    <div>
      ...
      <div className="relative w-full h-[90vh] top-100">
        <video autoPlay muted loop className="w-full h-full object-cover">
          <source src="src/assets/anime1.mp4" type="video/mp4" />
      ...
      <section className="px-8 py-16">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <h2 className="text-3x1 font-bold text-red-700">Actualidad</h2>
