...
const Home = () => {
    return (React.createElement("div", { className: "w-screen min-h-screen flex flex-col items-center bg-gradient-to-b from-green to-gray-900 pt-[150px] overflow-x-hidden" },
        React.createElement("section", { className: "relative w-full h-screen flex items-center justify-center mt-[0px]" },
            React.createElement("video", { autoPlay: true, muted: true, loop: true, playsInline: true, className: "absolute top-0 left-0 w-full h-full object-cover" },
                React.createElement("source", { src: "/videos/LogoAkai.mp4", type: "video/mp4" }),
            ...
            React.createElement("div", { className: "absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 text-white text-center px-8" },
                React.createElement("h1", { className: "text-2xl md:text-3xl font-semibold" }, "Sombras que narran historias"),
                React.createElement("h2", { className: "text-3xl md:text-5xl font-extrabold mt-4" }, "que transforman realidades"),
                React.createElement(Link, { to: "/trabajos" },
                    React.createElement("button", { className: "mt-6 px-8 py-3 bg-red-700 text-white font-semibold rounded-full text-base hover:bg-red-900 transition" }, "Nuestros trabajos")))),
